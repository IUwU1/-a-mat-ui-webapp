...
const matchesSM=useMediaQuery(theme.breakpoints.down('sm'));
    ...
    <Head>
            ...
            name="description" 
            key="description" 
            content="Visionary insights coupled with cutting edge technology.Get a free estimate today!" />
        </Head>
           <Grid item className={classes.rowContainer} >
               <Typography variant="h1" align={matchesMD?'center':undefined} style={{fontFamily:'Pacifico'}} >The Revolution</Typography>
           </Grid>     
           <Grid item container direction={matchesMD?'column':"row"} alignItems="center" style={{marginTop:'10em'}} justify="space-between" className={classes.rowContainer} >
               <Grid lg item style={{maxWidth:'40em'}} >
                <img src={"/assets/vision.svg"} alt="mountain vision" style={{maxWidth:matchesSM?300:'40em',marginRight:matchesMD? 0: '5em',marginBottom:matchesMD? '5em' : 0}} />
               </Grid>
           ...
           <Grid item container direction={matchesMD?'column':"row"} alignItems="center" style={{margin:'10em 0'}} className={classes.rowContainer} >
               ...
               <Grid lg item container direction="column"  style={{maxWidth:'40em'}}>
                 ...
                 <Grid  item>
                    ...
                    <Typography align={matchesMD?"center":undefined}  variant="body1" paragraph>
                    This puts personalization in your pocket — faster, better, and more affordable than ever before.                    </Typography>
                 </Grid>
               </Grid>
                <Grid item container justify={matchesMD?"center":"flex-end"} lg>
                <Lottie options={techOptions} style={{maxWidth:'40em',margin:"0"}} />
               </Grid>
           </Grid>
           <Grid item container direction={matchesMD?'column':"row"} align={matchesMD?"center":undefined}  justify="center" className={classes.rowContainer} >
           <Grid item>
               <Typography variant="h4" gutterBottom>Process</Typography>
           </Grid> 
           </Grid>
           <Grid item container direction={matchesMD?'column':"row"}  align={matchesMD?"center":undefined}  className={classes.rowContainer} style={{backgroundColor:'#B3B3B3',height:'90em'}} >
               ...
               <Grid item lg style={{alignSelf:'center'}}> 
                   <img src={"/assets/consultationIcon.svg"} alt="consultation shaking hand" style={{maxWidth:700}} width="100%" />
               </Grid>     
           </Grid>        
           <Grid item container direction={matchesMD?'column':"row"} align={matchesMD?"center":undefined}   className={classes.rowContainer} style={{backgroundColor:'#FF7373',height:'90em'}} >
               <Grid item container direction="column" lg  alignItems={matchesMD?"center":undefined}  >
                 <Grid item>
                 ...
                 <Grid item>
                     ...
                     <Typography variant="body1" paragraph style={{color:'#fff',maxWidth:'20em'}} >
                     This helps us understand and refine the solution itself before getting distracted by specifics and looks.                     </Typography>
                 </Grid> 
               </Grid>
               <Grid item lg style={{alignSelf:'center'}}>
                   <img src={"/assets/mockupIcon.svg"} alt="mockup" style={{maxWidth:1000}} width="100%" />
               </Grid>     
           </Grid> 
           <Grid item container direction={matchesMD?'column':"row"}  align={matchesMD?"center":undefined}  className={classes.rowContainer} style={{backgroundColor:'#39B54A',height:'90em'}} >
               <Grid item container direction="column" lg  alignItems={matchesMD?"center":undefined}  >
                 <Grid item>
           ...
           <Grid item container direction={matchesMD?'column':"row"} align={matchesMD?"center":undefined}   className={classes.rowContainer} style={{backgroundColor:'#A67C52',height:'90em'}} >
               <Grid item container direction="column" lg  alignItems={matchesMD?"center":undefined}  >
                 <Grid item>
               ...
               <Grid item lg style={{alignSelf:'center'}}>
                   <img src={"/assets/designIcon.svg"} alt="paint brush" width="100%" style={{maxWidth:1000}} />
               </Grid>     
           </Grid>  
           <Grid item container direction={matchesMD?'column':"row"}  align={matchesMD?"center":undefined}  className={classes.rowContainer} style={{backgroundColor:'#FBB03B',height:'90em'}} >
               <Grid item container direction="column" lg  alignItems={matchesMD?"center":undefined}  >
                 <Grid item>
                 ...
                 <Grid item>
                     ...
                     <Typography variant="body1" paragraph style={{color:'#fff',maxWidth:'20em'}} >
                     Only after our rigorous examinations will we accept a product as finished, then pushing it through the production pipeline. This produces an optimized, compressed, consumer version of the code and assets ready for deployment.                     </Typography> 
                 </Grid> 
               </Grid>
               <Grid item lg style={{alignSelf:'center'}}>
                   <img width="100%" src={"/assets/buildIcon.svg"} alt="build jcb machine" style={{maxWidth:matchesMD?700:1000}} />
               </Grid>     
           </Grid>  
           <Grid item container direction={matchesMD?'column':"row"} align={matchesMD?"center":undefined}   className={classes.rowContainer} style={{backgroundColor:'#C1272D',height:'90em'}} >
               <Grid item container direction="column" lg  alignItems={matchesMD?"center":undefined}  >
                 <Grid item>
                 ...
                 <Grid item>
                     ...
                     <Typography variant="body1" paragraph style={{color:'#fff',maxWidth:'20em'}} >
                     When you say the word, we press the button and launch your project out to the public. We’re there to ensure everything goes to plan so you can start reaping the rewards of your technological investment immediately.                     </Typography>
                      </Grid> 
               </Grid>
               <Grid item lg style={{alignSelf:'center'}}>
                   <img width="100%" src={"/assets/lunchIcon.svg"} alt="rocket nasa"  style={{maxWidth:200}}/>
               </Grid>     
           </Grid>   
           <Grid item container direction={matchesMD?'column':"row"}  align={matchesMD?"center":undefined}  className={classes.rowContainer} style={{backgroundColor:'#8E45CE',height:'90em'}} >
               <Grid item container direction="column" lg  alignItems={matchesMD?"center":undefined}  >
                 <Grid item>
                     <Typography variant="h4" gutterBottom style={{color:'#000',marginTop:'5em'}}>Launch</Typography>
                 </Grid>  
               ...
               <Grid item lg style={{alignSelf:'center'}}>
                   <img width="100%" src={"/assets/maintainIcon.svg"} alt="wrench nasa"  style={{maxWidth:500}}/>
               </Grid>     
           </Grid>   
           <Grid item container direction={matchesMD?'column':"row"} align={matchesMD?"center":undefined}   className={classes.rowContainer} style={{backgroundColor:'#28ABE2',height:'90em'}} >
               <Grid item container direction="column" lg  alignItems={matchesMD?"center":undefined}  >
                 <Grid item>
                 ...
                 <Grid item>
                     ...
                     <Typography variant="body1" paragraph style={{color:'#fff',maxWidth:'20em'}} >
                     Our iterative process will keep you current and competitive, allowing you to quickly implement changes instead of waiting months for a single update.                     </Typography>
                      </Grid> 
               </Grid>
               <Grid item lg style={{alignSelf:'center'}}>
                   <img width="100%" src={"/assets/iterateIcon.svg"} alt="dominoes" />
               </Grid>     
           </Grid> 
           <Grid item>
